---
title: Windows10下将Nginx注册为服务
tags:
  - Nginx
  - Windows
categories:
  - 技巧
createTime: 2022/01/22 15:17:56
permalink: /article/l4ovczl4/
---
...
```xml title="nginx-service.exe.config" :no-line-numbers
<configuration>
  <startup>
...
```xml title="nginx-service.xml" :no-line-numbers
<service>
  <id>nginx</id>
