...
categories:
  - 技巧
createTime: 2021/12/25 20:07:07
permalink: /article/k0xruml6/
---
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.1_01.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.2_01.webp)

我们可以看到断点的颜色是黄色，而不是之前的红色，此时以 debug 方式启动程序，会发现程序直接执行完成，而不会在断点处挂起。<br/>
但是我们可以看到控制台输出了断点到达行的详细信息。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.2_02.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.2_03.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.3_01.webp)

此时我们按下 **F9**，程序会停在该方法的最后一行。<br/>
这就是方法断点，只需要在方法处下一个断点，IDEA 就会自动在方法的首尾两处挂起，方便查看入参和返回的情况。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.3_02.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.3_03.webp)

此时以 debug 方式启动程序，会发现程序停在 `IServiceImpl` 类中 `execute()` 方法的第一行。这里有个菱形的断点标识，是程序自动显示的，并不是手动添加的。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.3_04.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.4_01.webp)

如图所示，这里有一个 **Java Exception Breakpoints** 的选项没有被勾选。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.4_02.webp)

点击左上角的 **＋**，并选择 **Java Exception Breakpoints**。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.4_03.webp)

会弹出一个面板，我们搜索并选中 **NullPointerException**，然后点击右下角的 **OK**。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.4_04.webp)

此时就添加并自动勾选了 **NullPointerException** 的选项，然后点击右下角的 **Done**。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.4_05.webp)

表示会对此种异常进行捕捉。当程序中任意位置产生了此种异常时，便会在异常的代码行处挂起。<br/>
此时以 debug 方式启动程序，会发现程序停止在了异常的代码行。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.4_06.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.5_01.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.5_02.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.5_03.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_01.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_02.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_03.webp)

然后，以 debug 方式启动程序，再次查看调用栈，发现只能看到 **main** 线程。因为断点处的代码是在 `main()` 方法中，线程上下文是在 **main** 线程中，而我们是以线程为单位挂起的，所以这里就只能看到 **main** 线程的调用栈。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_04.webp)


按下 **F9** 让程序执行完。<br/>
接着我们在如图所示处打一个断点，再次以 debug 方式启动程序。此时查看调用栈，发现可以看到 **t1**、**t2** 的线程，但 **t1** 线程前面有一个 **√**，这表示当前的线程的上下文是在 **t1** 这个线程中，我们同时可以看到右侧 num 变量的值为 100。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_05.webp)

如果我们在调用栈中选中 **t2** 这个线程呢，此时便可以看到 **t2** 线程的 num 值为 100000。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_06.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_07.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_08.webp)

按下 **F9** 让程序执行完。<br/>
右键单击此处断点，将 **Suspend** 切换到 **Thread** 选项，然后点击 **Done**。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_09.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_1.6_10.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.1_01.webp)

IDEA 会自动识别到当前程序的上下文变量，这个条件表示当变量 i 的值为偶数时，断点才生效。<br/>
然后以 debug 方式启动程序，可以看到只有 i 的值为 2, 4, 6, 8 的时候才会进入断点。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.1_02.webp)

那是否说明，只有 i 为偶数时程序才被执行到了呢？并不是，我们可以看控制台，发现 i 从 0 ~ 9 都被打印出来了，仅仅是 i 为偶数才会挂起程序。

同理，我们也可以在线程中设置断点的条件表达式。这里我们设置只有当线程名为 **t1** 时才将程序挂起。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.1_03.webp)

此时以 debug 方式启动程序，可以看到当前的挂起的线程是 **t1**，也只有 **t1** 会被挂起，**t2** 和 **t3** 线程均不会被挂起。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.1_04.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.2_01.webp)

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.2_02.webp)

然后勾选 **"Breakpoint hit" message** 和 **Stack trace**，点击右下角 **Done**。<br/>
以 debug 方式启动程序，可以看到控制台打印出了断点处的调用栈信息。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.2_03.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.3_01.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.4_01.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.4_02.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.5_01.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.6_01.webp)
...
![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.7_01.webp)

点击下方的 **Trace Current Stream Chain**。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.7_02.webp)

会打开一个 Stream Trace ，即流的追踪面板。<br/>
我们可以看到在此面板中，将程序中流的每一步数据操作的过程及结果都做了对应，可以很直观的看出数据在经过流中每一步操作之后的变化。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.7_03.webp)

默认是 **Split Mode** 视图分割模式，可以在上面的几个选项卡之间切换视图，当然也可以点击左下角的 **Flat Mode** 切换为扁平模式，数据将会在一个视图中展示，之后也可以点击走下角的 **Split Mode** 再切回视图分割模式。

![](https://cdn.jsdelivr.net/gh/Ma-yeah/picx-images-hosting@master/2021-12-25/01_2.7_04.webp)
