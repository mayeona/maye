...
categories:
  - Java
createTime: 2021/10/31 21:48:15
permalink: /article/9rsxx36x/
---
...
### 2.1. 自定义`HttpServletRequestWrapper`需要重写的方法
...
### 2.2. 自定义`HttpServletResponseWrapper`需要重写的方法
...
### 2.3. 使用`RequestBodyAdvice`、`ResponseBodyAdvice`做参数记录或加解密
...
Tip: 本文完整示例代码已上传至 [GitHub](https://github.com/Blogeee/blog-java/tree/main/_20211002)
