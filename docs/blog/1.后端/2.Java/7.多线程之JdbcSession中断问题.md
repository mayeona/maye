---
title: 多线程之JdbcSession中断问题
tags:
  - 多线程
  - 故障
categories:
  - Java
createTime: 2022/02/23 22:01:53
permalink: /article/kfadx5at/
---

## 前言

之前重构过一个基于 RabbitMQ 的多线程队列消费项目，原项目是用 Python 实现，我用 Java 重写，过程中也遇到过不少问题，一路披荆斩棘。
简单记一下曾经遇到过的问题：
